...
import 'firebase_options.dart'; // File generated by flutterfire CLI
import 'screens/home_screen.dart';
// import 'utils/mock_data_generator.dart'; // Import the mock data generator
...
class _AppLifecycleMonitorState extends State<AppLifecycleMonitor> with WidgetsBindingObserver {
  ...
  static const String APP_OPEN_STATUS_PATH = 'status/app_is_open';
  ...
  void _updateAppStatus(bool isOpen) async {
    try {
      ...
      await db.doc(APP_OPEN_STATUS_PATH)
        .set(
          {
            'open': isOpen,
      ...
      if (!isOpen) {
         await db.doc(STREAMING_STATUS_PATH)
          .set(
            {
